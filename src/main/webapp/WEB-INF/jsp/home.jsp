...
<body>
<img alt="my image" src="<c:url value="/resources/image/speed.png"/>">
<div class="container">
    <div class="card mx-auto mt-5 bg-primary" style="width: 50%;">
        ...
        <form action="search" class="mt-3">
            ...
            <div class="form-group">
                <input align="center" type="text" name="querybox" placeholder="Enter your keyword" class="form-controller"/>
            </div>
